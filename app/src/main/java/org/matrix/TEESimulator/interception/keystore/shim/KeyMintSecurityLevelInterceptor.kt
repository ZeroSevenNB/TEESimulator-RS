        ...
        return runCatching {
                ...
                val config =
                    CertGenConfig(
                        ...
                        uniqueId =
                            AttestationBuilder.computeUniqueIdOrNull(
                                params,
                                callingUid,
                        ...
                        idBrand = params.brand ?: DeviceAttestationService.CachedAttestationData?.brand,
                        idDevice = params.device ?: DeviceAttestationService.CachedAttestationData?.device,
                        idProduct = params.product ?: DeviceAttestationService.CachedAttestationData?.product,
                        idSerial = params.serial ?: DeviceAttestationService.CachedAttestationData?.serial,
                        idImei = params.imei,
                        idMeid = params.meid,
                        idManufacturer =
                            params.manufacturer ?: DeviceAttestationService.CachedAttestationData?.manufacturer,
                        idModel = params.model ?: DeviceAttestationService.CachedAttestationData?.model,
